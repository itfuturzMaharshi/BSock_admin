...
import { Ram } from "../../services/ram/ram.services";
        ...
        <form onSubmit={handleSubmit} className="p-4 sm:p-5 md:p-6 space-y-3 sm:space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Enter RAM description"
            />
          </div>
